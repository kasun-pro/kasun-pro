# 💫 About Me:
🔭 I’m currently working on event driven microserivces / serverless
<br>🌱 I’m currently learning cloud native development with go lang
 <br>⚡ Fun fact, I do cardistry sometimes 🃏
...
Frameworks: Next.js, React, Angular, Laravel
<br>Frontend Architectures: Redux, Flux, MVVM, MVC
<br>View Engines: Ivy (Angular), Fiber (React)
<br>State management implementations: NgRx Store (Angular), Redux (React)
<br>Design Systems: Material, Nebular, Eva
<br>Languages: Typescript, Javascript, PHP, SCSS, CSS, HTML
<br>Module Bundlers: Webpack
<br>Package managers: Npm, Composer
<br>Compilation Modes: AOT, JIT
<br>Unit Testing: Jest
<br>E2E Testing: Cypress, Selenium
<br>Other: Knowledge on micro-frontend architectures

## Backend Tecknologies

Languages: Javascript (NodeJS), Go, C#, Java, Python, PHP, C++, C
<br>Frameworks: SpringBoot (Java), ASP.Net Core (C#), Nest.js (JS), Flask/Django (Python)
<br>Package Managers: Npm, Maven, Nuget, Gradle, Composer, Pip, Helm
<br>Architectures: Even-Driven Microservices, Microservices, SOA, Monolithic
<br>Event/Message Brokers: Apache Kafka, RabitMQ, Redis Queue
<br>ORM tools: Hibernate (JPA)
<br>Unit Testing: JUnit (Java), XUnit (C#), Mocha
<br>Mocking Tools: Mockito (Java), AutoMoq (C#)

## Machine Learning / Deep Learning
TensorFlow
<br>Scikit-learn
<br>Matplotlib
<br>RNN, CNN, R-CNN, Mask R-CNN, LSTM
<br>YOLO 

## IoT Technologies
Arduino, ESP32, HC-10 Bluetooth 4.0 (BLE)
<br>Rasberry Pie
<br>Bio signal analysis with IoT (ECG, PPG)

## Authentication and Authorization Mechanisms
Flows: Authorization Code, Client Credentials, Resource Owner Password, PKCE
<br>Protocols: OAuth 2.0, OpenID Connect
<br>Improving security with Nonce, State, Code Verifier, Code Challenge

## Software design approaches
DDD (Domain-Driven Design), TDD (Test-Driven Design), BDD (Behavior-Driven Design)

## Database Technologies
Relational: MySQL, MSSQL, PostgreSQL
<br>Document Store: MongoDB
<br>Columnar Databases: Cassandra
<br>Graph Databases: Azure Cosmos Gremlin
<br>Key Value: Redis

## DevOps Tools
Platforms: GitLab, Azure DevOps, Bitbucket, Jenkins
<br>GitLab Features: GitLab Review Apps (Feature Flags etc)
<br>Experience: Implement CI/CD pipelines, Bash Scripting

## Container Technologies
Container Runtimes: Containerd (Docker), CRI-O (RedHat/IBM/etc)
<br>Container Orchestrators: Kubernetes, Docker Swarm

## Networking and System Administration
Routers: Cisco (EIGRP/OSPF)
<br>Services: DNS, DHCP, VPNs
<br>OSs: Linux (Centos, Ubuntu, Alpine)

## Logging and Monitoring Solutions
Logging: ELK (Elasticsearch, Logstash, and Kibana)
<br>Monitoring: Prometheus, Grafana, Kube-Prometheus Stack, Alert Manager

## Project Management Tools
Jira, Trello, Microsoft Planner

<!-- # 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=kasun-pro&theme=dark&hide_border=false&include_all_commits=true&count_private=true)<br/>
![](https://github-readme-streak-stats.herokuapp.com/?user=kasun-pro&theme=dark&hide_border=false)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=kasun-pro&theme=dark&hide_border=false&include_all_commits=true&count_private=true&layout=compact) -->

## 🏆 GitHub Trophies
![](https://github-profile-trophy.vercel.app/?username=kasun-pro&theme=radical&no-frame=false&no-bg=false&margin-w=4)

### ✍️ Random Dev Quote
![](https://quotes-github-readme.vercel.app/api?type=horizontal&theme=radical)
<!-- 
### 🔝 Top Contributed Repo
![](https://github-contributor-stats.vercel.app/api?username=kasun-pro&limit=5&theme=dark&combine_all_yearly_contributions=true) -->

### 😂 Random Dev Meme
<img src='https://randommeme-five.vercel.app/' style="height: 400px;"/>

---
[![](https://visitcount.itsvg.in/api?id=kasun-pro&icon=0&color=0)](https://visitcount.itsvg.in)
<!-- 
  ## 💰 You can help me by Donating
  [![BuyMeACoffee](https://img.shields.io/badge/Buy%20Me%20a%20Coffee-ffdd00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black)](https://buymeacoffee.com/sddaf) [![PayPal](https://img.shields.io/badge/PayPal-00457C?style=for-the-badge&logo=paypal&logoColor=white)](https://paypal.me/sdf) [![Patreon](https://img.shields.io/badge/Patreon-F96854?style=for-the-badge&logo=patreon&logoColor=white)](https://patreon.com/sdf) [![Ko-Fi](https://img.shields.io/badge/Ko--fi-F16061?style=for-the-badge&logo=ko-fi&logoColor=white)](https://ko-fi.com/fsdf)  -->
